...
alias gcl='git clean -xdfq -e "*.ReSharper.user" -e "_ReSharper.Main" -e "*.suo" -e "*.csproj.user" -e "*.vbproj.user" -e "*.ncrunchsolution" -e "*.ncrunchproject" -e "_NCrunch_Main" -e ".TODO"'
